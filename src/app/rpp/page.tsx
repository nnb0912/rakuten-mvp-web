      ...
      <section className="panel rpp-view-guide" id="rpp-guide">
        ...
        <div className="rpp-guide-video">
          <div className="rpp-guide-video-copy">
            <div><span className="rpp-guide-video-badge">3分04秒</span><b>全利用者向け 使い方マニュアル動画</b></div>
          ...
          <video controls playsInline preload="metadata" aria-label="RPP CONTROL 使い方マニュアル動画">
            <source src="/rpp/manuals/rpp-control-guide-v5.mp4" type="video/mp4" />
            お使いのブラウザでは動画を再生できません。
          </video>
          <a href="/rpp/manuals/rpp-control-guide-v5.mp4" download>動画をダウンロード</a>
        </div>
        ...
        <div className="rpp-guide-grid">
          ...
          <article><div><span>06</span><b>実験履歴</b></div><p>既存の検索順位・固定CPC実験は開始値と終了値を同じ指標で比較できます。通常運用の3モードは終了日不要で、実験履歴を新規作成しません。</p><Link href="/rpp?view=products">商品・KW・実験を開く →</Link></article>
